...
//        listPhong = phong_dao.getDanhSachPhong();//không cần hàng này vì ta đã truyền tham số vào , để có thể sử dụng được nhiều hơn
    ...
    private void initComponents() {
        ...
        btnFilter.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnUpdate.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnAdd.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnRefresh.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnDelete.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnSearch.setBackground(new java.awt.Color(9, 146, 213));
        ...
        jPanel8.setBackground(new java.awt.Color(255, 169, 114));
