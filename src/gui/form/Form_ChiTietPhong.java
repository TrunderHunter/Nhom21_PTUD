...
//    @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        btnThayDoiSoLuong.setBackground(new java.awt.Color(9, 146, 213));
        btnThayDoiSoLuong.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        btnThayDoiSoLuong.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btnTinhTien.setBackground(new java.awt.Color(9, 146, 213));
