...
//        txtMaDichVu.setText("");
    ...
    private void initComponents() {
        ...
        jPanel5.setBackground(new java.awt.Color(255, 169, 114));
        ...
        btnAnh.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnSuaDV.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnThemDV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icon/add-user.png"))); // NOI18N
        ...
        btnXoaDV.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnTimDV.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnLuuDichVuKhiThem.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnLuuDichVuKhiSua.setBackground(new java.awt.Color(9, 146, 213));
...
//            txtMaDichVu.setEnabled(true);
    ...
    private void btnXoaDVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaDVActionPerformed
        ...
        if (r == -1) {
            ...
            int selectOption = JOptionPane.showConfirmDialog(null, "Bạn có muốn xóa dịch vụ này hay không?", 
