...
public class Form_ForgotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        show_MatKhau1.setBorderPainted(false);
        show_MatKhau1.setContentAreaFilled(false);
        show_MatKhau1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                show_MatKhau1ActionPerformed(evt);
            }
        });
        jPanel2.add(show_MatKhau1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 200, 50, 40));
        jPanel2.add(txtNewPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 390, 40));
        ...
        show_MatKhau.setBorderPainted(false);
        show_MatKhau.setHideActionText(true);
        show_MatKhau.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                show_MatKhauActionPerformed(evt);
            }
        });
        jPanel2.add(show_MatKhau, new org.netbeans.lib.awtextra.AbsoluteConstraints(378, 289, 40, 40));
        jPanel2.add(txtConfirmPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 390, 40));

        btnOk.setBackground(new java.awt.Color(9, 146, 213));
        ...
        txtPass1.setCaretPosition(0);
        txtPass1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtPass1ActionPerformed(evt);
            }
        });
        jPanel2.add(txtPass1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 390, 40));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 450, 410));
