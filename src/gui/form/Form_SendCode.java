...
public class Form_SendCode extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSend.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnExit.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnVertify.setBackground(new java.awt.Color(9, 146, 213));
        btnVertify.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btnVertify.setForeground(new java.awt.Color(255, 255, 255));
