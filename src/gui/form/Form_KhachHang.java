...
public class Form_KhachHang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        chkGioiTinh.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                chkGioiTinhKeyReleased(evt);
            }
        });
        ...
        btnTimKH.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnThemKH.setBackground(new java.awt.Color(9, 146, 213));
        btnThemKH.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        btnThemKH.setForeground(new java.awt.Color(255, 255, 255));
        btnThemKH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icon/add-user.png"))); // NOI18N
        ...
        btnXoaKH.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnReset.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnSuaKH.setBackground(new java.awt.Color(9, 146, 213));
        ...
        btnLuu.setBackground(new java.awt.Color(9, 146, 213));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnTimKH, javax.swing.GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(btnThemKH, javax.swing.GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(btnReset, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(btnSuaKH, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(btnXoaKH, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                .addGap(15, 15, 15)
                .addComponent(btnLuu, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel7.setBackground(new java.awt.Color(255, 169, 114));
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        lamMoiTextField();
        if (btnTimKH.getText().equalsIgnoreCase("Hủy")) {
    ...
    private void btnTimKHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKHActionPerformed
        ...
        if (btnTimKH.getText().trim().equalsIgnoreCase("Tìm")) {
            moKhoaTextField(true);
            ArrayList<KhachHang> ds = dao_KhachHang.getAllKhachHang();
            txtMaKH.setEnabled(true);
            if (txtMaKH.getText().trim().equals("") && txtTenKhachHang.getText().trim().equals("")
                    && txtSDTKH.getText().trim().equals("") && txtCCCD.getText().trim().equals("")) {
                xoaBang();

                themDuLieuVaoBang(ds);
            } else {
                if (!txtMaKH.getText().trim().equals("")) {
                    timTheoTxtField("maKH", txtMaKH, "Không tìm thấy mã khách hàng!");
                } else if (!txtTenKhachHang.getText().trim().equals("")) {
                    timTheoTxtField("tenKH",txtTenKhachHang, "Không tìm thấy tên khách hàng!");
                } else if (!txtCCCD.getText().trim().equals("")) {
                    timTheoTxtField("CCCD", txtCCCD, "Không tìm thấy CCCD/CMDD tương ứng!");
                } else if (!txtSDTKH.getText().trim().equals("")) {
                    timTheoTxtField("SDT", txtSDTKH, "Không tìm thấy SDT tương ứng!");
                }
            }
        }
    }//GEN-LAST:event_btnTimKHActionPerformed

    private void timTheoTxtField(String loaiField, JTextField txt, String mess) {
        ArrayList<KhachHang> ds = dao_KhachHang.getAllKhachHang();
        Pattern pattern = Pattern.compile(txt.getText().trim().toString());
        ArrayList<KhachHang> list = new ArrayList<KhachHang>();
        for (KhachHang kh : ds) {
            Matcher matcher = null;
            if(loaiField.trim().equalsIgnoreCase("maKH"))
               matcher = pattern.matcher(kh.getMaKhachHang());
            else if(loaiField.trim().equalsIgnoreCase("tenKH"))
               matcher = pattern.matcher(kh.getHoTenKhachHang());
            else if(loaiField.trim().equalsIgnoreCase("CCCD"))
               matcher = pattern.matcher(kh.getCCDD());
            else if(loaiField.trim().equalsIgnoreCase("SDT"))
               matcher = pattern.matcher(kh.getSoDienThoai());
    ...
    private void chkGioiTinhKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_chkGioiTinhKeyReleased

    }//GEN-LAST:event_chkGioiTinhKeyReleased
...
private void themDuLieuVaoBang(ArrayList<KhachHang> dsKhachHang) {
    ...
    private boolean kiemTraDuLieuVao() {
        ...
        if(ngaySinh.length()<=0 || txtNgaySinh.getDate().after(Date.valueOf(LocalDate.now()))){
      JOptionPane.showConfirmDialog(null, "Ngày sinh phải nhỏ hơn hoặc bằng ngày hiện tại và không được để trống",
